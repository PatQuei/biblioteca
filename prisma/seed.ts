...
async function main() {
  ...
  await prisma.book.create({
    data: {
      ...
      cover: '[https://placehold.co/300x400/dc2626/white?text=1984](https://placehold.co/300x400/dc2626/white?text=1984)',
      status: 'LIDO',
      genreId: distopia.id,
    },
  });
  ...
  await prisma.book.create({
    data: {
      ...
      cover: '[https://placehold.co/300x400/f97316/white?text=SdA](https://placehold.co/300x400/f97316/white?text=SdA)',
      status: 'LENDO',
      currentPage: 500,
      genreId: fantasia.id,
    },
  ...
  await prisma.book.create({
    data: {
      ...
      cover: '[https://placehold.co/300x400/16a34a/white?text=Duna](https://placehold.co/300x400/16a34a/white?text=Duna)',
      status: 'QUERO_LER',
      genreId: ficcao.id,
    },
  });
